...
def welcomepic(pic, user, chatname, id, uname, brightness_factor=1.3):
    ...
    draw.text((800, 300), f'NAME: {unidecode(user)}', fill=(255, 255, 255), font=font)
    draw.text((500, 500), f'ID: {id}', fill=(255, 255, 255), font=font)
    draw.text((900, 30), f"USERNAME : {uname}", fill=(255,255,255),font=font)
    pfp_position = (100, 250)
