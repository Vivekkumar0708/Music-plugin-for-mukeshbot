...
def welcomepic(pic, user, chatname, id, uname, brightness_factor=1.3):
    ...
    draw.text((1680, 1500), f'NAME: {unidecode(user)}', fill=(255, 255, 255), font=font)
    draw.text((1680, 1900), f'ID: {id}', fill=(255, 255, 255), font=font)
    draw.text((1680, 1330), f"USERNAME : {uname}", fill=(255,255,255),font=font)
